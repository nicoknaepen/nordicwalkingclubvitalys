    ...
    <div id="header" class="clearfix">
        ...
        <div id="logo-floater"> 
            ...
            <div class="clearfix">
                ...
                <?php if ($site_slogan): ?>
                <span id="site-name"><!--<span id="slogan">--><?php print $site_slogan; ?></span>
                <?php endif; ?>
            </div>
            <?php endif; ?>
        ...
        <div class="main_view">
            <div class="window">
                <div class="image_reel">
                    <a href="<?php print url('node/3'); ?>"><img src="<?php print base_path() . drupal_get_path('theme', 'bluemasters') . '/images/nwcv/slide-image-1.jpg'; ?>"></a>
                    <a href="<?php print url('node/2'); ?>"><img src="<?php print base_path() . drupal_get_path('theme', 'bluemasters') . '/images/nwcv/slide-image-2.jpg'; ?>"></a>
                    <!--<a href="<?php print url('node/1'); ?>"><img src="<?php print base_path() . drupal_get_path('theme', 'bluemasters') . '/images/nwcv/slide-image-1.jpg'; ?>"></a>-->
                </div>
                <div class="descriptions">
                    <div class="desc" style="display: none;">Nordic Walking</div>
                    <div class="desc" style="display: none;">Club Vitalys</div>
                    <!--<div class="desc" style="display: none;">Nordic Walking Club Vitalys</div>-->
                </div>
            </div>
